...
public class Box2DFragment_yh extends AndroidFragmentApplication implements InputProcessor {
	...
	//粒子效果绘制层
	private Box2dEffectView_yh box2dEffectView;
	//Fragment 处于销毁过程中标志位
...
//		box2dEffectView.release();
	...
	public void addStar(TanChuangBean bean, int type, Bitmap bitmap) {
		try {

			box2dEffectView.addStar(bean,type,bitmap);
	...
	public void buildGDX() {
		box2dEffectView = new Box2dEffectView_yh(getActivity());
